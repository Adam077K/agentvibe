...
**Where it is: 222 tests / 0 fail across 8 files** (VERIFIED on `main` = `28626d8`, `bun test`, 77.2 s at load 13.7→5.9,
exit 0 — 193 at phase close on `30f6c35`, 205 at `01fcadd`; #34, #36 and #35 added the difference). **The test count is stable; the
