...
- **Improve a skill:** Open a PR with your changes; follow the structure in `.claude/skills/docs/SKILL_ANATOMY.md`
...
- **README:** Keep the root README GSA-focused; skills docs live in `.claude/skills/`
...
- **Workflow bundles:** Document in `guides/workflow-bundles.md` and `.claude/skills/docs/WORKFLOWS.md`
