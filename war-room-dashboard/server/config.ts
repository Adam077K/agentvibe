...
export const CONFIG = {
  port: 4200,
  clientDevPort: 4201,
  projectStateDir: join(HOME, '.agentvibe'),
  projectDir: join(HOME, 'VibeCoding', 'Agentvibe'),
  worktreesDir: join(HOME, 'VibeCoding', 'Agentvibe', '.worktrees'),
  claudeProjectsDir: join(HOME, '.claude', 'projects'),
  tmuxSession: 'agentvibe',
  intervals: {
    state: 2000,
    tmux: 3000,
    events: 1000,
