...
description: "Agentvibe billing patterns using Paddle: webhook signature verification, checkout session creation, customer portal URL generation, price ID conventions, and subscription lifecycle. Stripe is not used — Paddle is the only payment provider."
tags: [billing, agentvibe-specific, backend, payments]
...
- Stripe is not in the Agentvibe stack. Any Stripe reference is legacy and should be removed.
