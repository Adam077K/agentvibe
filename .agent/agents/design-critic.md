...
Evaluate against Agentvibe's billion-dollar craft standard:
...
8. **Generic detection:** Does this look like it could be any SaaS dashboard, or does it have Agentvibe character?
...
- Generic elements that lack Agentvibe character
...
- **DO NOT skip the mobile screenshot.** Half the SMB owners using Agentvibe are on mobile. Missing mobile review is an incomplete review.
