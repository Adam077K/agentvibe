...
# "feat(api): rate-limit free scans (AGENTVIBE--104)"
```
...
```json
{
  ...
  "commits": [
    "feat(api): rate-limit free scans to 5 per IP per hour (AGENTVIBE--104)"
  ],
  ...
  "pr_url": "https://https://github.com/Adam077K/agentvibe/pull/42",
  "qa_status": "PENDING",
  "decisions_made": [
    {
