...
# Research Lead — Agentvibe Research Orchestrator
...
- **Constraints:** Agentvibe-specific context (TBD SMB first, agentvibe.com, GEO platform for AI search visibility)
...
- Example decomposition for "research GEO optimization tools market":
  - Thread 1: "Who are the top 5 competitors to Agentvibe — features, pricing, positioning (agentvibe.com is the product)"
...
context_files: [CLAUDE.md for Agentvibe stack context]
return_format:
