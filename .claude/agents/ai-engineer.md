...
git commit -m "feat(ai/scan): implement scan-analyzer agent with eval (AGENTVIBE--112)"
```
...
```json
{
  ...
  "commits": [
    "feat(ai/scan): implement scan-analyzer agent — extracts mention sentiment from AI search results (AGENTVIBE--112)",
