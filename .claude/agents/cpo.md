...
6. Linear ticket via `mcp__linear__get_issue` (if AGENTVIBE--N is referenced in brief)
...
```
Reach:      How many Agentvibe users or prospects are affected per quarter?
...
## Solution
[What Agentvibe builds — what it does and explicitly does NOT do]
...
- **DO NOT assume Stripe.** Agentvibe uses Paddle exclusively. Any spec referencing billing must use Paddle terminology: `subscription`, `checkout`, `price_id`, `14-day money-back guarantee`.
