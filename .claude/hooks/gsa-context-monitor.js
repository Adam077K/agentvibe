#!/usr/bin/env node
// POSTURE: ADVISES — every path is process.exit(0). Reports context pressure; never intervenes.
...
//   - Disabled if AGENTVIBE_NO_AUTOCOMPACT=1 env var is set
...
process.stdin.on('end', () => {
  try {
    ...
    const autoCompactDisabled = process.env.AGENTVIBE_NO_AUTOCOMPACT === '1';
