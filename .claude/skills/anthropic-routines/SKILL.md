...
description: "How to write a Agentvibe Routine .md file: required frontmatter fields (schedule, routine_id_env_key, budget, trust-spec parsing), body conventions, and MCP grant patterns. Use when authoring or refining any file under .claude/agents/_routines/."
tags: [orchestration, agentvibe-specific, agents, routines]
...
1. Extract spec from `---AGENTVIBE--SPEC-V1-START---` / `---AGENTVIBE--SPEC-V1-END---` sentinels
