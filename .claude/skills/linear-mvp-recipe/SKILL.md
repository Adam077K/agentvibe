...
description: "Agentvibe's locked Linear label vocabulary, sub-ticket creation pattern, and single-synthesis-comment style. Use whenever any CEO or C-suite agent interacts with Linear tickets, creates sub-tickets, or posts comments."
tags: [workflow, agentvibe-specific, linear, orchestration]
...
await linear.createComment({
  ...
  body: `---AGENTVIBE--SPEC-V1-START---\n${JSON.stringify(spec, null, 2)}\n---AGENTVIBE--SPEC-V1-END---`,
});
```
...
```
Agentvibe — Main (product work)        ← Adam and agents work here
Agentvibe — War Room (orchestration)   ← Standing Routines post here, separate from product
Agentvibe — Strategy (board meetings)  ← Board meeting outputs
```
