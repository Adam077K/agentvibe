...
Testing, review, auth, secrets, compliance — what stops it shipping broken

| Skill | What it carries |
|---|---|
| `auth-implementation-patterns` | Master authentication and authorization patterns including JWT, OAuth2, session management, and RBAC to build secure, scalable access control… |
