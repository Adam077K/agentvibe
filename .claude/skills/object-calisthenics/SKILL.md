...
description: Use when writing or refactoring object-oriented code and wanting hard structural constraints rather than style advice. Jeff Bay nine rules as enforceable limits — max two instance variables, no getters or setters on domain objects, first-class collections, one level of indentation.
---
